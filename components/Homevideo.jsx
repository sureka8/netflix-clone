...
import { InfoIcon, PlayCircle } from "lucide-react";
 ...
 export default function Homevideoplayer(){
   const  data= [
      ...
      const [firstMovie,setFirstMovie] = useState(data[0])
      console.log(firstMovie);
      
    return(
        <div className="h-[55vh] lg:h-[60vh] flex items-center justify-start w-full">
            <video 
            poster={firstMovie.imageString}
            autoPlay
           muted
          loop
         src={firstMovie.videoSource}
         className="w-full absolute top-0 left-0 h-[60vh] object-cover -z-10 brightness-[60%]">
            ...
            <div className=" absolute w-full lg:w-1/2 px-5 lg:px-14">
                <h1 className="text-4xl md:text-5xl lg:text-6xl text-white font-bold">{firstMovie.title}</h1>
                <p className="text-white text-sm md:text-lg mt-5 line-clamp-3">{firstMovie?.overview}</p>
